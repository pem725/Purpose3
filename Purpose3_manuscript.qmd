...
## Longitudinal Prediction of Stress-Related Growth

In the 2-year longitudinal subsample, baseline purpose predicted stress-related growth (PTG) with a partial correlation of .19 after controlling for happiness; happiness predicted PTG at .15 after controlling for purpose. The two estimates are close, and across the seven longitudinal outcomes each construct produced two unique effects. We therefore find only modest, and roughly equal, prospective prediction of growth---not the clear purpose advantage we anticipated. Attrition to *N* = 119 at 2-year follow-up limits power for this comparison, so we read the longitudinal results as suggestive rather than decisive.
