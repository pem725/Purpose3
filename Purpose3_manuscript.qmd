...
The DRM analyses showed a consistent pattern. Purpose was a stronger predictor of goal-directed engagement during daily episodes---meaning derived from activities, values-consistency, and effort expenditure---while happiness was a stronger predictor of momentary positive emotions during goal pursuit. The two constructs appear to operate through different mechanisms: purpose drives engagement and meaning extraction, while happiness tracks positive affective experience.
...
The longitudinal analyses provided the most stringent test of our hypotheses. Baseline purpose uniquely predicted stress-related growth (PTG) at 2-year follow-up after controlling for happiness, consistent with the hypothesis that purpose supplies the motivation to find meaning in adversity. This finding extends prior work on psychological flexibility and resilience: the benefits are not simply a function of feeling happy but reflect a directed orientation toward meaningful goals.
